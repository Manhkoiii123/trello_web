...
function CardActivitySection({ onAddCardComment, cardComments = [] }) {
  ...
  const handleAddCardComment = (event) => {
    ...
    if (event.key === "Enter" && !event.shiftKey) {
      ...
      if (!event.target?.value || !event.target.value.trim()) return; // Nếu không có giá trị gì thì return không làm gì cả
